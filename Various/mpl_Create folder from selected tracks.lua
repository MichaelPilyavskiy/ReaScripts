...
-- @changelog
--    # use SWS copy/paste tracks with routing
    ...
    function main()    
      ...
      -- name folder track
        ...
        --[[
        for i = CountSelectedTracks(0), 1, -1 do 
          DeleteTrack( GetSelectedTrack(0,i-1) ) 
        end]]
      ...
      -- deal with parent/child structure
        ...
        SetMediaTrackInfo_Value( 
          CSurf_TrackFromID(insert_id+CountSelectedTracks(0), false), 'I_FOLDERDEPTH', -1 )
