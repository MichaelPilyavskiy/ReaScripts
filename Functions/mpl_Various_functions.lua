...
-- @changelog
--    # remove mouse_ismoving condition for left drag, less performant but less buggy on complex structures


    
  VF_version = 3.52 -- do not remove, used for versions comparement
