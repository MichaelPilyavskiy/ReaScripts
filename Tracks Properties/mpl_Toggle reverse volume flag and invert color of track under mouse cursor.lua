--[[
   * ReaScript Name: Toggle reverse volume flag and invert color of track under mouse cursor
...
script_title = "Toggle reverse volume flag and invert color of track under mouse cursor"
