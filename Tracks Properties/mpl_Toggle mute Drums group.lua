-- @description Toggle mute Drums group
-- @version 1.0
-- @author MPL
-- @website https://forum.cockos.com/showthread.php?t=207971
-- @about Toggle mute group tracks which contain "drums" in their name
-- @changelog
--    + init
...
function main()
  for i = 1, reaper.CountTracks(-1) do
    ...
    if trname:lower():match('drums') and depth == 1 then
...
main()
reaper.Undo_EndBlock2(-1, 'Toggle mute Drums group', 0xFFFFFFFF)
