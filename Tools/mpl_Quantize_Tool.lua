...
bugs = 
" Expected bugs could not be fixed for this release:".."\n".. 
...
about = "Quantize tool by Michael Pilyavskiy ".."\n"..
    ...
    "Donation (as I know it is for russians only, I don`t really know a".."\n"..
    "good service for donations around the world):".."\n"..
    "    QIWI +79102035901".."\n"..
...
"bar start.".."\n"
help2 = "4.3.3.1 Thin white lines represent beat start.".."\n"..
...
"  Ãëàâíîå îêíî.".."\n"..
"\n"..
"Â ëåâîé ÷àñòè íàõîäèòñÿ îêíî âûáîðà ðåôåðåíñà. Òî åñòü ìû ìîæåì".."\n"..
"âûäåëèòü êàêèå-ëèáî îáúåêòû â àðàíæèðîâêå è çàïîìíèòü èõ â ".."\n"..
"êà÷åñòâå òî÷åê êâàíòèçàöèè, òî åñòü òîãî, ê ÷åìó ìû áóäåì ".."\n"..
"êâàíòèçèðîâàòü. Ïîñëåäíèå äâà ïóíêòà ÿâëÿþòñÿ òàêæå ñëàéäåðàìè.".."\n"..
"Ïðàâûé êëèê ïî swing grid âûçûâàåò îêíî äëÿ ðó÷íîãî ââîäà ".."\n"..
"çíà÷åíèÿ.".."\n"..
"\n"..
"Â ïðàâîé ÷àñòè - îáúåêòû, êîòîðûå ìû áóäåì êâàíòèçèðîâàòü, ".."\n"..
"ò.å. òÿíóòü ê òî÷êàì. Èõ ìû çàïîìèíàåì â ïàìÿòü òåì æå ñïîñîáîì".."\n"..
"- âûäåëÿåì â àðàíæèðîâêå è çàòåì êëèêàåì â ñêðèïòå.".."\n"..
"\n"..
"Â îáåèõ ÷àñòÿõ â ñêîáêàõ óêàçûâàåòñÿ êîëè÷åñòâî âçÿòûõ òî÷åê ".."\n"..
"èëè îáúåêòîâ ñîîòâåòñòâåííî.".."\n"..
"\n"..
"Äèñïëåé - çåë¸íûìè ïîëîñêàìè ïîêàçûâàåò òî÷êè êâàíòèçàöèè, ".."\n"..
"ñèíèìè - ïåðâîíà÷àëüíî çàïîìíåííûå ïîçèöèè îáúåêòîâ êâàíòèçàöèè.".."\n"..
"Ïîñåðåäèíå - óñëîâíàÿ ïîëîñà âðåìåíè. Òîëñòîé ïîëîñîé ïîêàçàíû ".."\n"..
"bars, òîíêèìè - beats.".."\n"..
"\n"..
"Êíîïêà â íèæíåé ÷àñòè ÿâëÿåòñÿ:".."\n"..
"a) ñîáñòâåííî êíîïêîé 'ïðèìåíèòü',".."\n"..
"á) ïðè óäåðæèâàíèè ìåíÿåòñÿ ñèëà ïðèæàòèÿ,".."\n"..
"â) ïðè îäèíî÷íîì êëèêå ïðàâîé êíîïêîé ïîçèöèè îáúåêòîâ ".."\n"..
"âîññòàíàâëèâàþòñÿ. ".."\n"..
"\n"..
"Ñëåâà íàõîäèòñÿ êíîïêà ïåðåõîäà ìåæäó ãëàâíûì îêíîì è îêíîì ".."\n"..
"îïöèé.".."\n"..
"\n"..
"Ñåêöèÿ ðåôåðåíñà:".."\n"..
"Snap Reference Mode.".."\n"..
"Â ðåæèìå Global çàïîìèíàþòñÿ ðåàëüíûå ïîçèöèè òî÷åê íà ".."\n"..
"âðåìåííîé ëèíèè. Ò.å. åñëè ìû âûáåðåì, íàïðèìåð, àéòåì íà ".."\n"..
"÷åòâ¸ðòîé ñåêóíäå, çàïîìíèòñÿ òîëüêî 4-àÿ ñåêóíäà. Â ðåæèìå ".."\n"..
"Local èç êàæäîé ïîëó÷åííîé òî÷êè ðåôåðåíñà â ñåêóíäàõ ".."\n"..
"èçâëåêàåòñÿ çíà÷åíèå â beats. Äàëåå èç ýòèõ êîíâåðòèðîâàííûõ ".."\n"..
"ïîçèöèé ãåíåðèðóåòñÿ ïàòòåðí. Òî åñòü, åñëè ìû âûáåðåì â ýòîì ".."\n"..
"ðåæèìå àéòåì íà ÷åòâ¸ðòîé ñåêóíäå, ñêðèïò âûñ÷èòàåò, êàêîå ".."\n"..
"ìåñòî çàíèìàåò àéòåì â ñâî¸ì êâàäðàòå, è ñãåíåðèðóåò ýòî æå ".."\n"..
"çíà÷åíèå âðåìåíè äëÿ äðóãèõ êâàäðàòîâ àðàíæèðîâêè, ãðóáî ".."\n"..
"ãîâîðÿ, ñôîðìèðóåò íåâèäèìóþ ñåòêó, ñîñòîÿùóþ èç îäíîãî ".."\n"..
"çíà÷åíèÿ.".."\n"..
"\n"..
"Pattern length - äëèííà ãåíåðèðóåìîãî ïàòòåðíà.".."\n"..
"\n"..
"Pattern edges - äîáàâëÿåò ãðàíèöû â ïàòòåðí.".."\n"..
"\n"..
"Ref.velocity - ïîìèìî ïîçèöèé îáúåêòîâ, ïðèìåíÿåò óðîâåíü. ".."\n"..
"íàïðèìåð, åñëè ðåôåðåíñ - íîòû, òî èõ velocity ïðèìåíèòñÿ ".."\n"..
"êàê óðîâåíü äëÿ àéòåìîâ. Êíîïêà Use velocity ÿâëÿåòñÿ òàêæå ".."\n"..
"ñëàéäåðîì, óêàçûâàþùèì, íàñêîëüêî ìû õîòèì èñïîëüçîâàòü ".."\n"..
"ãðîìêîñòü ðåôåðåíñíûõ îáúåêòîâ. Ðàçóìååòñÿ, ýòî íå ðàáîòàåò ".."\n"..
"äëÿ ñòðåò÷ ìàðêåðîâ.".."\n"..
"\n"..
"Ref.Notes - ïðè âûáîðå Notes â êà÷åñòâå ðåôåðåíñà îïöèîíàëüíî ".."\n"..
"áåð¸ò ëèáî âñå íîòû â âûáðàííîì àéòåìå, ëèáî òîëüêî âûäåëåííûå.".."\n"..
"\n"..
"Ñåêöèÿ êâàíòàéçà:".."\n"..
"\n"..
"Snap area - äåëàåì êâàíòàéç âñåõ ïîçèöèé îáúåêòîâ èëè òîëüêî ".."\n"..
"òåõ, êîòîðûå íàõîäÿòñÿ â êàêîì-òî ðàäèóñå îò òî÷åê êâàíòèçàöèè.".."\n"..
"Ðàäèóñ îïðåäåëÿåòñÿ ñëàéäåðîì Use Gravity. Ýòà ôóíêöèÿ ".."\n"..
"àêòóàëüíà äëÿ ñòðåò÷ìàðêåðîâ â êà÷åñòâå îáúåêòîâ äëÿ ".."\n"..
"êâàíòèçàöèè.".."\n"..
"\n"..
"Snap direction:".."\n"..
"Ïîâåäåíèå ïðèâÿçêè. Ñòàíäàðòíûé êâàíòàéç, ê êîòîðîìó ìû ".."\n"..
"ïðèâûêëè - to closest point.".."\n"..
"\n"..
"Swing scaling - 1x - ýòî ñëåäóþùèé áèò, 0.5x - ïîâåäåíèå ".."\n"..
"MIDI Editor.".."\n"..
"\n"..
"Quantize notes - àíàëîãè÷íî ñõîæåìó ïóíêòó â ðåôåðåíñå - ".."\n"..
"êâàíòèçèðóåò âñå íîòû â âûáðàííîì àéòåìå èëè òîëüêî òå, ".."\n"..
"êîòîðûå âûäåëåíû.".."\n"
 ...
 function DEFINE_dynamic_variables() 
   ...
   sm_rel_ref_menu_names_t = {"Ref. str.markers:", "Bar relative", "Item relative"}
 ...
 function DEFINE_default_variables_GUI()
  ...
  -- options areas --
  ref_options_area_xywh_t = {x_offset, snap_mode_menu_xywh_t[2],width1, 125}
   ...
   ------------------
     ...
     if options_button_state == true then    
      ...
      -- buttons
       ...
       GUI_button(help_button_xywh_t, "Help (RU/EN)","Help (RU/EN)", _, true)
           ...
           if  str_markers_count ~= nil then
             for j = 1, str_markers_count, 1 do             
              ...
              if  ref_str_mark_pos > 0 and ref_str_mark_pos/takerate < ref_item_len-0.000001 then
                if sm_rel_ref_values_t[1] ==1 then
                  table.insert(ref_sm_pos_t, ref_sm_pos)              
                 else
                  table.insert(ref_sm_pos_t, ref_sm_pos-ref_item_pos)
                end   
              end
             end -- for
...
---------------------------------------------------------------------------------------------------------------
 ...
 function MOUSE_get() 
  ...
  --|||-- SNAP DEST SETTING    
     ...
     ------ reference relative sm ------      
     if sm_rel_ref_xywh_buttons_t ~= nil then
       if MOUSE_clickhold_under_gui_rect(sm_rel_ref_xywh_buttons_t,0) == true then sm_rel_ref_values_t = {1, 0} end
       if MOUSE_clickhold_under_gui_rect(sm_rel_ref_xywh_buttons_t,4) == true then sm_rel_ref_values_t = {0, 1} end
     end     
  ...
  --|||-- BUTTONS -----     
     ...
     reaper.ShowConsoleMsg("") reaper.ShowConsoleMsg(help1..help2..help3) end  
