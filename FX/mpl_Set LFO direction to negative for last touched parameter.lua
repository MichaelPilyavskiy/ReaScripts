-- @description Set LFO direction to negative for last touched parameter
-- @version 1.01
-- @author MPL
...
--    # VF independent
  ...
  if VF_CheckReaperVrs(6.37,true) then   
    Undo_BeginBlock2( 0 )
    main()
    Undo_EndBlock2( 0, 'Set LFO direction to negative for last touched parameter', 0xFFFFFFFF )
  end 
