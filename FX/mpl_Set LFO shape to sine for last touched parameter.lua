-- @description Set LFO shape to sine for last touched parameter
-- @version 1.0
-- @author MPL
...
--    + init
  ...
  function main()
     ...
     TrackFX_SetNamedConfigParm( tr, fxnumber, 'param.'..paramnumber..'.lfo.shape', 0)
  ...
  local ret = VF_CheckFunctions(3.50) if ret then local ret2 = VF_CheckReaperVrs(6.37,true) if ret2 then  
    Undo_BeginBlock2( 0 )
    main()
    Undo_EndBlock2( 0, 'Set LFO shape to sine for last touched parameter', 0xFFFFFFFF )
  end end
