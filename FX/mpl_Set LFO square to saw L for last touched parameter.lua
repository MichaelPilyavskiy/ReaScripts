-- @description Set LFO square to saw L for last touched parameter
-- @version 1.01
-- @author MPL
...
--    # VF independent
  ...
  function main()
     ...
     TrackFX_SetNamedConfigParm( tr, fxnumber, 'param.'..paramnumber..'.lfo.shape', 2)
  ...
  if VF_CheckReaperVrs(6.37,true)  then  
    Undo_BeginBlock2( 0 )
    main()
    Undo_EndBlock2( 0, 'Set LFO shape to saw L for last touched parameter', 0xFFFFFFFF )
  end 
