-- @description Build time selection based on audio of take under mouse cursor
-- @version 1.0
-- @author MPL
...
------------------------------------------------------------------------------------------------------  
  function main()
    ...
    startsegm=pos_st+itpos
    endsegm=pos_end+itpos
    
    GetSet_LoopTimeRange2( -1, 1, false, startsegm, endsegm, false )
